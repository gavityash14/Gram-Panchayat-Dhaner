          ...
          <div className="flex flex-col md:flex-row mt-16 justify-center">
            <div className="flex-row">
              ...
              <h3 className="text-start font-bold mt-16">
                {language === 'en'
                  ? 'Your Government Service Center, Dhaner'
                  : 'आपले सरकार सेवा केंद्र, धनेर '}
              </h3>
              ...
              <p
                ...
                dangerouslySetInnerHTML={{
                  __html:
                    language === 'en'
                      ? '<strong>Center Operator:</strong> Dilip Gokul Ahire <br />Mobile Number: 9765091915'
                      : '<strong>केंद्र चालक:</strong> दिलीप गोकुळ अहिरे <br />मोबाईल क्रमांक: 9765091915',
                }}
              ></p>
            </div>
